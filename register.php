...
<div class="row register">
  <div class="col-lg-6 col-lg-offset-3 col-sm-6 col-sm-offset-3 col-xs-12 ">
      ...
      <input type="text" class="form-control" placeholder="Full Name" name="form_name">
                ...
                <input type="password" class="form-control" placeholder="Password" name="form_phone" required autocomplete="off">
                <input type="password" class="form-control" placeholder="Confirm Password" name="cform_phone">
